...
const DownloadQuotationsPDF = ({ quotation }) => {
  const handleDownloadPDF = () => {
    ...
    const rows = quotation.map((qtn, index) => [
      index + 1,
      qtn.quotationId,
  ...
  return (
    ...
    >
      <div className="flex justify-center"><Download className="w-5 h-5 me-1"/>  Download Quotation</div>
    </button>
  );
};
